...
$txt = 'LAPORAN DATA SISWA MENJAHIT';
...
$ckdata = $this->db->query("SELECT view_member.nama,view_member.jns_kel,tbl_agama.agama as nama_agama,tbl_pendidikan.nama as nama_pendidikan,view_member.no_hp,tbl_pekerjaan.nama as nama_pekerjaan FROM view_member INNER JOIN tbl_agama ON view_member.id_agama = tbl_agama.id INNER JOIN tbl_pendidikan ON view_member.id_pendidikan = tbl_pendidikan.id INNER JOIN tbl_pekerjaan ON view_member.id_pekerjaan = tbl_pekerjaan.id WHERE view_member.id_tipe = '1'")->result();
